...
| Quand | Quoi |
|---|---|
| **lun. 31/08** | Coaching **Elisabeth** 10h · cron notes iOS 1ère exécution 18h (journal à vérifier le 01/09) |
...
**Vidéo suivante : Gandhi.** **V4 de David — prête à tourner** → [[Mnemonaute Script - Gandhi et le développement personnel]]. Une seule vidéo, ~22 min. Restent trois broutilles : « et aujourd'hui sur Instagram » (cohérence avec les 17 ans), le CTA à resserrer + la signature de fin qui a disparu, et le titre à caler sur la miniature déjà faite. Décision à prendre : le juron du cold open coûte la monétisation — sans effet sur la portée.
