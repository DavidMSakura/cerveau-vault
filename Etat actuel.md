...
**Vidéo suivante : Gandhi.** **V4 de David — prête à tourner** → [[Mnemonaute Script - Gandhi et le développement personnel]]. Une seule vidéo, ~22 min. **Miniatures faites le 31/08** (Higgsfield + photo réelle en référence) : deux candidates qui passent le test 210 px — *Gandhi écrasé sous le rocher* et *Dev perso toxique ?* → `~/Documents/Mnemonaute/Gandhi vs. Dev perso/B-roll/07 - Miniatures/Retenues/`. À lancer en A/B Test & Compare. Restent deux broutilles de script : « et aujourd'hui sur Instagram » (cohérence avec les 17 ans) et le CTA à resserrer. Décision à prendre : le juron du cold open coûte la monétisation — sans effet sur la portée.
