...
**Vidéo suivante : Gandhi.** **V4 de David — prête à tourner** → [[Mnemonaute Script - Gandhi et le développement personnel]]. Une seule vidéo, ~22 min. **Miniatures — trois candidates qui passent le test 210 px** → `~/Documents/Mnemonaute/Gandhi vs. Dev perso/B-roll/07 - Miniatures/Retenues/`. **A = « Il n'a jamais dit ça »** (la croix rouge sur la citation) est la meilleure : seule à dire ce que la vidéo raconte, et seule à respecter la charte jaune/blanc de la 9,8/20 — **mais elle est molle, à régénérer en natif** (c'est un upscale d'hier, 1280×720). Challengers : *Gandhi écrasé sous le rocher*, *Dev perso toxique ?*. A/B Test & Compare ensuite. Restent deux broutilles de script : « et aujourd'hui sur Instagram » (cohérence avec les 17 ans) et le CTA à resserrer. Décision à prendre : le juron du cold open coûte la monétisation — sans effet sur la portée.
